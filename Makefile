...
SRCS = main.cpp Core/UserLogin/login.cpp Core/Menu/mainmenu.cpp Core/APIs/apicall_KiteConnect_OHLC.cpp Core/APIs/apicall_KiteConnect_LTP.cpp Core/setNonBlockingMode.cpp Core/Orders/buy-sell.cpp Core/Portfolio/portfolio.cpp Core/Positions/intraday.cpp Core/Watchlist/watchlist.cpp Core/Funds/funds.cpp Core/TradeHistory/tradehistory.cpp
